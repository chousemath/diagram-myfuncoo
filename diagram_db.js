...
[Board | ID::int(11) | UpdatedAt::decimal(13,3) | UserID::int(11) | Category::int(11) | Status::int(11) | Theme::varchar(45) | Content::textCreatedAt::decimal(13,3)]
[BoardImage | ID::int(10) | BoardID::int(10) | Status::int(10) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3)CreatedAt::decimal(13,3)]
[BoardReply | ID::int(11) | UpdatedAt::decimal(13,3) | BoardID::int(11) | UserID::int(11) | Category::int(11) | Status::int(11) | Theme::varchar(45) | Content::textCreatedAt::decimal(13,3)]
[Card | ID::int(11) | Category::int(11) | BillingKey::varchar(45) | Status::int(11) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3) | LastFour::varchar(45) | CardBrand::int(11) | ExpMonth::int(11) | ExpYear::int(11) | Name::varchar(45)CreatedAt::decimal(13,3)]
[CartItem | ID::int(11) | ProductID::int(11) | Status::int(11) | Count::int(11) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3) | ShareCode::varchar(45)CreatedAt::decimal(13,3)]
[Category | ID::int(11) | Status::int(11) | ImageURL::text | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3)CreatedAt::decimal(13,3)]
...
[CouponCategory | ID::int(11) | TollValue::int(11) | DiscountValue::float | ImageURL::text | Name::varchar(45) | Description::text | Duration::int(11) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3) | Price::decimal(10,2) | Status::int(11) | Quantity::int(11) | BonusQuantity::int(11)CreatedAt::decimal(13,3)]
...
[DeliveryItemOption | ID::int(11) | ProductOptionID::int(11) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3)CreatedAt::decimal(13,3)]
[FiatExchangeRate | ID::int(11) | UpdatedAt::decimal(13,3) | KRW::float | USD::float | Category::int(11)CreatedAt::decimal(13,3)]
[LineItem | ID::int(10) | MerchantID::varchar(250) | ProductID::int(10) | CouponID::int(10) | Title::varchar(250) | Amount::decimal(10,2) | TollAmount::int(10) | DiscountAmount::decimal(10,2) | DiscountTollAmount::int(10) | Quantity::int(10) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3) | DeliveryItemID::int(10)CreatedAt::decimal(13,3)]
[Lottery | ID::int(11) | UpdatedAt::decimal(13,3) | ProductID::int(11) | Status::int(11) | StartsAt::decimal(13,3) | EndsAt::decimal(13,3) |MinToll::int(11) | MaxToll::int(11) | MinParticipants::int(11) | MaxParticipants::int(11) | Quantity::int(10) | WinnerCount::int(10) | TollPrice::int(10) | ViewCount::int(10) | ParticipantCount::int(10) | TollAmount::int(10) | WinningTickets::textCreatedAt::decimal(13,3)]
...
[Product | ID::int(11) | Description::text | Status::int(11) | Position::int(11) | Category::int(11) | DeliveryMethod::int(11) | MaxDiscount::decimal(10,2) | SourcingOrigin::text | Thumbnail::text | ImageURL::text | Stock::int(11) | Merchant::varchar(45) | Domestic::int(11) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3) | ProductionPrice::decimal(10,2) | SellPrice::decimal(10,2) | FakePrice::decimal(10,2) | MaxSalePrice::decimal(10,2) | Color::int(10) | Width::decimal(10,2) | Length::decimal(10,2) | Height::decimal(10,2) | SourcingCountry::int(10) | Handling::text | QualityAssurance::text | ASContact::text | TollPrice::int(10) | ViewCount::int(10) | CouponLimit::int(11)CreatedAt::decimal(13,3)]
[ProductImage | ID::int(11) | UpdatedAt::decimal(15,3) | ProductID::int(11) | Status::int(11) | ImageURL::textCreatedAt::decimal(13,3)]
[ProductOption | ID::int(11) | Name::varchar(45) | Description::text | AddedCost::decimal(10,2) | CreatedAt::decimal(13,3) | UpdatedAt::decimal(13,3) | Status::int(10)CreatedAt::decimal(13,3)]
[ProductPolicy | ID::int(11) | UpdatedAt::decimal(13,3) | ProductID::int(11) | Category::int(11) | Content::textCreatedAt::decimal(13,3)]
...
[ReviewReply | ID::int(11) | UpdatedAt::decimal(13,3) | ReviewID::int(11) | UserID::int(11) | Category::int(11) | Status::int(11) | Theme::varchar(45) | Content::textCreatedAt::decimal(13,3)]
[Session | ID::int(11) | UpdatedAt::decimal(13,3) | Name::varchar(45) | Nickname::varchar(45) | Email::varchar(45) | Password::varchar(45) |Phone::varchar(45) | Status::int(11) | HashAccount::varchar(45) | TollBalance::int(11) | AuthID::varchar(45) | Token::textCreatedAt::decimal(13,3)]
